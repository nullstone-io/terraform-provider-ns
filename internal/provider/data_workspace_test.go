...
func TestDataWorkspace(t *testing.T) {
	checks := resource.ComposeTestCheckFunc(
		...
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.%`, "7"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.app.kubernetes.io/name`, "block0"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.app.kubernetes.io/part-of`, "stack0"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.app.kubernetes.io/managed-by`, "nullstone"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.nullstone.io/block`, "block0"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.nullstone.io/stack`, "stack0"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.nullstone.io/env`, "env0"),
		resource.TestCheckResourceAttr("data.ns_workspace.this", `k8s_labels.nullstone.io/block-ref`, "yellow-giraffe"),
